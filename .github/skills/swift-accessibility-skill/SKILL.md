...
- **Don't branch on `UIAccessibility.isVoiceOverRunning`.** Users switch between assistive technologies; detecting specific tech creates fragile code. Detect *settings* (Reduce Motion, Contrast) instead.

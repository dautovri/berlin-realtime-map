...
### `.accessibilityLinkedGroup(id:in:)` — iOS 17+

Links elements that are semantically related but not adjacent in the view hierarchy.

```swift
@Namespace var imageGroup

Image("photo")
    .accessibilityLinkedGroup(id: "photo1", in: imageGroup)
